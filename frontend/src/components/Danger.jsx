const Danger = () => {
  return (
    <>
      <div class="absolute top-0 left-0 w-full h-full bg-white/[.8] rounded-md dark:bg-gray-800/[.4]"></div>

      <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full p-6">
        <div
